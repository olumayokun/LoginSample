package com.fowels.loginsample.ui
...
import com.fowels.loginsample.ui.auth.LoginFragment
    ...
    when {
        ...
        failure.errorCode == 401 -> {
            if (this is LoginFragment) {
                requireView().snackbar("You've entered an incorrect email or password")
            } else {
